...
CARD1="alsa_output.pci-0000_03_00.6"
CARD2="alsa_output.pci-0000_03_00.1"
...
function showHelp() {
  ...
  echo "-d, --hdmi        Sets HDMI speakers as output device"
  echo "-l, --laptop      Sets laptop speakers as output device"
